...
export const JOBS: Job[] = [
  { id: 'J-2401', img: 'https://images.unsplash.com/photo-1471478331149-c72f17e33c73?auto=format&fit=crop&w=800&q=80', title: 'A&Rディレクター', co: "rockin'on inc.", coLogo: 'R', cat: 'A&R・プロデュース', emp: '正社員', loc: '東京・渋谷', salary: '600〜900万円', salaryNum: 900, tags: ['マネジメント', '新人発掘', 'ライブ'], fav: true, new: true, posted: '2日前', desc: 'アーティストの発掘から作品制作・プロモーションまでを一貫して担当。レーベル運営の中核を担うポジションです。', applyType: 'form' },
  { id: 'J-2402', img: 'https://images.unsplash.com/photo-1605723517503-3cadb5818a0c?auto=format&fit=crop&w=800&q=80', title: 'ライブプロダクション マネージャー', co: 'Sound Stage Tokyo', coLogo: 'S', cat: 'ライブ制作', emp: '正社員', loc: '東京・港区', salary: '500〜750万円', salaryNum: 750, tags: ['現場統括', 'フェス', 'PA/照明'], fav: false, new: true, posted: '3日前', desc: 'フェス・ライブの現場を統括。会場手配、スタッフ管理、進行管理まで公演全体をマネジメントします。', applyType: 'form' },
  { id: 'J-2403', img: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?auto=format&fit=crop&w=800&q=80', title: 'マスタリングエンジニア', co: 'Studio Sonic', coLogo: 'SO', cat: 'レコーディング', emp: '業務委託', loc: 'リモート可', salary: '応相談', salaryNum: 0, tags: ['ProTools', 'Dolby Atmos'], fav: false, new: false, posted: '5日前', desc: '配信・パッケージ向けのマスタリング業務。Dolby Atmos など立体音響制作の経験者を歓迎します。', applyType: 'external', applyUrl: 'https://studiosonic.example.com/careers' },
  { id: 'J-2404', img: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=800&q=80', title: 'MVディレクター', co: 'Grain Pictures', coLogo: 'G', cat: '映像・写真', emp: '契約社員', loc: '東京・中野区', salary: '450〜650万円', salaryNum: 650, tags: ['ミュージックビデオ', '撮影', '編集'], fav: true, new: false, posted: '1週間前', desc: 'ミュージックビデオの企画・撮影・編集を担当。アーティストの世界観を映像で表現するクリエイティブ職です。', applyType: 'form' },
  { id: 'J-2405', img: 'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?auto=format&fit=crop&w=800&q=80', title: 'フェスブッキング担当', co: 'Night Owl Fest', coLogo: 'N', cat: 'マネジメント', emp: '正社員', loc: '大阪・北区', salary: '420〜600万円', salaryNum: 600, tags: ['アーティスト交渉', '海外'], fav: false, new: true, posted: '今日', desc: 'フェス出演アーティストのブッキング・交渉を担当。国内外のマネジメントとの折衝を行います。', applyType: 'form' },
  { id: 'J-2406', img: 'https://images.unsplash.com/photo-1493863641943-9b68992a8d07?auto=format&fit=crop&w=800&q=80', title: '楽曲プロデューサー（EDM/Pop）', co: 'Neon Records', coLogo: 'NR', cat: 'A&R・プロデュース', emp: '業務委託', loc: 'リモート可', salary: '成果報酬', salaryNum: 0, tags: ['DTM', 'Logic', 'Ableton'], fav: false, new: false, posted: '4日前', desc: '所属アーティストへの楽曲提供・プロデュース。トラックメイクからアレンジまで幅広く手がけます。', applyType: 'external', applyUrl: 'https://neonrecords.example.com/jobs' },
  { id: 'J-2407', img: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?auto=format&fit=crop&w=800&q=80', title: 'アーティストマネージャー', co: 'Blue Echo Artists', coLogo: 'BE', cat: 'マネジメント', emp: '正社員', loc: '東京・代官山', salary: '400〜550万円', salaryNum: 550, tags: ['スケジュール管理', '広報'], fav: false, new: false, posted: '1週間前', desc: '所属アーティストのスケジュール管理・現場同行・広報対応など、活動全般をサポートします。', applyType: 'form' },
  { id: 'J-2408', img: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80', title: 'PA/音響エンジニア', co: 'Live House Moonlight', coLogo: 'LM', cat: 'ライブ制作', emp: '正社員', loc: '東京・下北沢', salary: '350〜480万円', salaryNum: 480, tags: ['ライブハウス', 'SR'], fav: true, new: false, posted: '10日前', desc: 'ライブハウスでのPA・音響オペレーション。仕込みから本番、撤収までライブの音をつくる仕事です。', applyType: 'form' },
  { id: 'J-2409', img: 'https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?auto=format&fit=crop&w=800&q=80', title: 'Web編集者（音楽メディア）', co: "rockin'on inc.", coLogo: 'R', cat: '編集・ライター', emp: '正社員', loc: '東京・渋谷', salary: '420〜600万円', salaryNum: 600, tags: ['編集', 'インタビュー', 'SEO'], fav: false, new: false, posted: '2週間前', desc: '音楽メディアの記事編集・インタビュー取材を担当。企画立案からSEOを意識した編集まで行います。', applyType: 'form' },
]
