...
export function Hero({ nav }: { nav: Nav }) {
  ...
  const slides = [
    { img: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80', pos: '50% 38%', grain: true, co: 'ソニーミュージックエンタテイメント', role: 'A＆R ディレクター（新人アーティスト発掘）' },
    { img: 'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?auto=format&fit=crop&w=1200&q=80', pos: '50% 50%', grain: false, co: "rockin'on inc.", role: 'フェスプロデューサー（ROCK IN JAPAN FES.）' },
    { img: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=1200&q=80', pos: '50% 32%', grain: false, co: 'Grain Pictures', role: 'MV ディレクター（映像演出・編集）' },
  ]
